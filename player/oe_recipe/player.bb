...
-DENABLE_DRIVER_DIOLATCH=OFF -DENABLE_DRIVER_DUMMY=ON -DENABLE_DRIVER_EEDHCONTROLLER=OFF -DENABLE_DRIVER_EPUCK=OFF -DENABLE_DRIVER_ER1=OFF -DENABLE_DRIVER_ERRATIC=OFF \
